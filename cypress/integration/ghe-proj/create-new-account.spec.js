...
describe('sign up and role', () => {
  ...
  context('creates new account and approve', () => {
    before('',() => {
            ...
            cy.wrap(`moigioi${_randomAccountNumber}`).as('accountName')
    ...
    it('create agency account and check for existing log in name', function()  {
      ...
      cy.get('div > h5').contains('Search').click().then (() =>{
